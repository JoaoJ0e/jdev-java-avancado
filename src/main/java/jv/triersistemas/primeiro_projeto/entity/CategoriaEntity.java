...
public class CategoriaEntity {
	...
	public CategoriaEntity(CategoriaDto categoriaDto) {
		...
		this.prioridadeEnum = categoriaDto.getPrioridadeEnum();
	}


	public void atualizaCategoria(CategoriaDto categoriaAtualizada) {
		this.nome = categoriaAtualizada.getNome();
		this.descricao = categoriaAtualizada.getDescricao();
		this.prioridadeEnum = categoriaAtualizada.getPrioridadeEnum();	
	}
}
